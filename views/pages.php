<section id="pages__pic">
    <div id="pages__overlay">
        <h2 class="text-center fw-bold"><span class="fw-light">Zoom sur les actualités </span><br> <span class="text-uppercase"><?= $continent ?></span></h2>
    </div>
</section>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            for ($i = 0; $i < $numberItems && $i < count($items); $i++) {
                ...
                $formatter->setPattern('EEEE dd MMMM YYYY à H:mm');
                ...
                <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center">
                    <div class="card my-3">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item text-capitalize"><?= $formattedDate ?></li>
                        </ul>
